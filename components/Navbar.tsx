...
import { Keyboard, Trophy, User, Users, Swords, LogOut, LogIn, Settings } from 'lucide-react';
...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="flex items-center justify-between px-8 py-4 max-w-7xl mx-auto w-full sticky top-0 z-50 bg-bg-primary/80 backdrop-blur-md border-b border-transparent transition-all duration-300">
      <Link to="/" className="flex items-center gap-3 group">
        ...
        <div className="flex flex-col">
          ...
          <span className="text-[10px] text-text-secondary uppercase tracking-[0.2em] font-medium group-hover:text-accent transition-colors">professional</span>
        </div>
      </Link>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative group cursor-pointer" onClick={() => navigate('/profile')}>
            ...
            <button 
              ...
              className="absolute -bottom-1 -right-1 w-5 h-5 bg-bg-secondary rounded-full flex items-center justify-center border border-bg-tertiary text-error hover:bg-error hover:text-white transition-all shadow-md z-10"
              title="Chiqish"
            >
